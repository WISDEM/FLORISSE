...
class floris_windframe(Component):
    ...
    def __init__(self, nTurbines, nSamples=0):
        ...
        self.add('wsw_position', Array(np.zeros([2, nSamples]), iotype='out', units='m', desc='position of desired measurements in wind ref. frame'))
...
class floris_wcent_wdiam(Component):
    ...
    def __init__(self, nTurbines, nSamples=0):
        ...
        self.add('wsw_position', Array(np.zeros([2, nSamples]), iotype='in', units='m', desc='positions where measurements are desired in the windframe'))
