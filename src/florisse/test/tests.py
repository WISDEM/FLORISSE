...
#
#
# class TotalDerivTestsFlorisUnifiedAEPOpt(unittest.TestCase):
#
#     def setUp(self):
...
class GradientTestsFLORIS(unittest.TestCase):
    ...
    def setUp(self):
        ...
        # set up problem
        prob = Problem(root=AEPGroupFLORIS(nTurbines, nDirections=1, resolution=0, use_rotor_components=False))
...
class GradientTestsCtCp(unittest.TestCase):
    ...
    def setUp(self):
        ...
        # set up problem
        prob = Problem(root=AEPGroupFLORIS(nTurbines=nTurbines, use_rotor_components=False))
...
class GradientTestsFlorisUnifiedDV(unittest.TestCase):
    ...
    def testUnified_velocitiesTurbines(self):
        np.testing.assert_allclose(self.J['all_directions.direction_group0.myFloris.f_0'][('velocitiesTurbines0', 'turbineXw')]['J_fwd'], self.J['all_directions.direction_group0.myFloris.f_0'][('velocitiesTurbines0', 'turbineXw')]['J_fd'], self.rtol, self.atol)
        np.testing.assert_allclose(self.J['all_directions.direction_group0.myFloris.f_0'][('velocitiesTurbines0', 'turbineYw')]['J_fwd'], self.J['all_directions.direction_group0.myFloris.f_0'][('velocitiesTurbines0', 'turbineYw')]['J_fd'], self.rtol, self.atol)
        np.testing.assert_allclose(self.J['all_directions.direction_group0.myFloris.f_0'][('velocitiesTurbines0', 'yaw0')]['J_fwd'], self.J['all_directions.direction_group0.myFloris.f_0'][('velocitiesTurbines0', 'yaw0')]['J_fd'], self.rtol, self.atol)
        np.testing.assert_allclose(self.J['all_directions.direction_group0.myFloris.f_0'][('velocitiesTurbines0', 'rotorDiameter')]['J_fwd'], self.J['all_directions.direction_group0.myFloris.f_0'][('velocitiesTurbines0', 'rotorDiameter')]['J_fd'], self.rtol, self.atol)
        np.testing.assert_allclose(self.J['all_directions.direction_group0.myFloris.f_0'][('velocitiesTurbines0', 'Ct')]['J_fwd'], self.J['all_directions.direction_group0.myFloris.f_0'][('velocitiesTurbines0', 'Ct')]['J_fd'], self.rtol, self.atol)
        np.testing.assert_allclose(self.J['all_directions.direction_group0.myFloris.f_0'][('velocitiesTurbines0', 'axialInduction')]['J_fwd'], self.J['all_directions.direction_group0.myFloris.f_0'][('velocitiesTurbines0', 'axialInduction')]['J_fd'], self.rtol, self.atol)
