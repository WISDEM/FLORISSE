...
from floris_openmdao1 import FLORIS, DirectionGroupFLORIS, AEPGroupFLORIS, ParallelAEPGroupFLORIS
...
class ParallelOptAEP(Group):
    ...
    def __init__(self, nTurbines, resolution=0, nDirections=1, minSpacing=2.):
        ...
        super(ParallelOptAEP, self).__init__()

        # add major components and groups
        self.add('AEPgroup', ParallelAEPGroupFLORIS(nTurbines=nTurbines, nDirections=nDirections), promotes=['*'])
        self.add('spacing_comp', SpacingComp(nTurbines=nTurbines), promotes=['*'])
